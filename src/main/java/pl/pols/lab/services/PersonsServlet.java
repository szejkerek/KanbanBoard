...
public class PersonsServlet extends HttpServlet {
    ...
    Column column;
    Task task = new Task("Sample task title", "Sample task content");
    Task task1 = new Task("Sample task title1", "Sample task content1");
    Task task2 = new Task("Sample task title2", "Sample task content2");

    @Override
    public void init() {
        persons = new Persons();

        column = new Column("fghjk");
        column.addTask(task);
